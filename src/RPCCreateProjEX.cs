...
public partial class RPCCreateProj : RPC {
	public static Dictionary<int, ProjCreate> functs = new Dictionary<int, ProjCreate> {
		...
		*/
		...
		{ (int)RockProjIds.ScorchWheelUnderwaterSpawn, UnderwaterScorchWheelSpawn.rpcInvoke},
		{ (int)RockProjIds.ScorchWheelUnderwaterProj, UnderwaterScorchWheelProj.rpcInvoke},

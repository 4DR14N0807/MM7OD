public static class SMPhysics {
	...
	public static float skidRun = 0.3125f;

	public static float maxFall = 4;
	public static float baseJump = 4;
	public static float jumpMul = 0.125f;
}

...
public partial class RPCCreateProj : RPC {
	public static Dictionary<int, ProjCreate> functs = new Dictionary<int, ProjCreate> {
		...
		*/
		...
		{ (int)RockProjIds.FreezeCracker, FreezeCrackerRmProj.rpcInvoke },
		{ (int)RockProjIds.FreezeCrackerPiece, FreezeCrackerPieceRmProj.rpcInvoke },
		{ (int)RockProjIds.ThunderBolt, ThunderBoltRmProj.rpcInvoke },
		{ (int)RockProjIds.ThunderBoltSplit, ThunderBoltSplitRmProj.rpcInvoke },
		{ (int)RockProjIds.JunkShield, JunkShieldRmProj.rpcInvoke},
		{ (int)RockProjIds.JunkShield2, JunkShieldRmProj2.rpcInvoke},
		{ (int)RockProjIds.ScorchWheelSpawn, ScorchWheelSpawnRm.rpcInvoke},
		{ (int)RockProjIds.ScorchWheel, ScorchWheelRmProj.rpcInvoke},
		{ (int)RockProjIds.ScorchWheelMove, ScorchWheelMoveRmProj.rpcInvoke },
		...
		{ (int)RockProjIds.DangerWrap, DangerWrapBubbleRmProj.rpcInvoke },
		{ (int)RockProjIds.WildCoil, WildCoilRmProj.rpcInvoke },
		{ (int)RockProjIds.WildCoilCharged, WildCoilChargedRmProj.rpcInvoke },
		...
		{ (int)BluesProjIds.LemonOverdrive, BreakBusterProj.rpcInvoke },
		...
		{ (int)BluesProjIds.BusterBreak, ChargedBreakBusterProj.rpcInvoke },
